    ...
    <div id="filter-section" style="margin-bottom: 20px; padding: 15px; background-color: #f0f7ff; border-radius: 5px; display: <?= !empty($filtres) ? 'block' : 'none' ?>;">
        <form method="GET" action="">
            <div style="display: flex; flex-wrap: wrap; gap: 15px; align-items: flex-end;">
                ...
                <div style="flex: 0.5; min-width: 100px;">
                    <a href="dashboard_factures.php" class="btn-reset" style="display: block; text-align: center; background-color: #6c757d; color: white; text-decoration: none; padding: 8px 15px; border-radius: 5px;">
