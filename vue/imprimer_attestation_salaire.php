...
<head>
    ...
    <title>Attestation_Salaire_<?= $emp['nom'] ?>_<?= $emp['prenom'] ?></title>
        ...
        <div class="content">
            <div class="attestation-body">
                ...
                <div class="employee-details">
                    ...
                    <p><strong>Fonction :</strong> <?= $emp['poste'] ?></p>
                    <p><strong>Date d'embauche :</strong> <?= date('d/m/Y', strtotime($emp['date_embauche'])) ?></p>
                </div>

                <p>Est employé(e) au sein de notre société et perçoit un salaire mensuel de :</p>

                <p style="text-align: center; font-size: 24px; font-weight: bold; margin: 40px 0; color: var(--primary-color); border: 2px dashed var(--border-color); padding: 20px; border-radius: 10px; background: #fff;">
                    <?= number_format($emp['salaire'], 2) ?> Dirhams
                </p>
